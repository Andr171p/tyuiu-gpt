...
if TYPE_CHECKING:
    from src.infrastructure.checkpoint_savers.redis.redis_types import (
        RedisCheckpointKey,
...
from src.infrastructure.checkpoint_savers.redis.constants import REDIS_KEY_SEPARATOR
